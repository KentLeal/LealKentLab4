package com.example.kjele.lealkentlab4;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("4ITE",  "onCreat() has executed.");
    }
    ...
    public void showMessageNext(View view) {

        Snackbar.make( view, "Next Button", Snackbar.LENGTH_LONG).show();
